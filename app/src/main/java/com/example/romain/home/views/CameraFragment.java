 ...
 */
public class CameraFragment extends Fragment implements RequestReciever<Bitmap> {
...
//        }
    ...
    @Override
    public void onResponce(Bitmap resonce, Requests request) {
        img.setImageBitmap(resonce);
    }
